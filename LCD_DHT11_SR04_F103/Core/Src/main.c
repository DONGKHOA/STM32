...
static uint8_t effect = MODE_SR_04;
/* USER CODE END PV */
...
void EFFECT_Handle()
{
  if (condition)
  {
    ...
    case MODE_SR_04:
      ...
      {
        distance = SR04_Get_Distance(&sr04_0);
...
int main(void)
{
  ...
  SR04_Init(&sr04_0, &htim4, GPIOA, GPIO_PIN_1, GPIOA, GPIO_PIN_0);
  /* USER CODE END 2 */
